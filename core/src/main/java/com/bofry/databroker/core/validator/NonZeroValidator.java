...
public class NonZeroValidator extends AbstractValidator {
    @Override
    public void validate(String fieldName, Object input) throws InvalidObjectException, ValidationException {
        ...
        ValidationException e = new ValidationException(String.format("%s : Non zero integer verification failed.", fieldName));
