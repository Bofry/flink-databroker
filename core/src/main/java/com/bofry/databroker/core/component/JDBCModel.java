...
public class JDBCModel extends Model implements Serializable {

    public JDBCModel(String className, Map<String, MappingField> modelMapping, Map<String, MappingField> srcMapping, IObjectDescriptor descriptor) throws Exception {
